...
async def send_welcome(message: Message):
    ...
    await message.answer(
        ...
        "\n✨ <b>Как начать:</b>"
        "\n<b>1.</b> Введите команду <a>/reg</a> для регистрации."
        ...
        "\nЕсли у вас возникнут вопросы, не стесняйтесь обращаться к нашей поддержке! <code>/admin!</code> \n"
...
async def empty_message(message: Message):
    await message.answer(
        "🚫 Ой! Команда неизвестна. Пожалуйста, проверьте введённое и попробуйте снова.\n"
